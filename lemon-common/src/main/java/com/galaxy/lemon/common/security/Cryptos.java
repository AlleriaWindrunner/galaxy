...
package com.galaxy.lemon.common.security;
...
public class Cryptos {
	 ...
	 */
	public static String aesEncrypt(String input, String key) throws UnsupportedEncodingException, DecoderException {
	 ...
	 */
	public static String aesDecrypt(String input) throws DecoderException, UnsupportedEncodingException {
	 ...
	 * @param key 符合AES要求的密钥
	 */
	public static String aesDecrypt(String input, String key) throws DecoderException, UnsupportedEncodingException {
