...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.SimpleSelectElementGenerator;
...
public class XMLMapperGenerator extends AbstractXmlGenerator {
    ...
    protected XmlElement getSqlMapElement() {
        ...
        addSelectElement(answer);    //FIXME
        return answer;
    }
    
    protected void addSelectElement(XmlElement parentElement) {
        AbstractXmlElementGenerator elementGenerator = new SimpleSelectElementGenerator();
