...
public class UnableToAcquireLockException extends LemonException {

    private static final long serialVersionUID = 4121125716772813963L;
    public UnableToAcquireLockException() {
        super(ErrorMsgCode.UNABLE_ACQUIRE_DISTRIBUTED_LOCK);
    }

    public UnableToAcquireLockException(Exception e) {
        super(ErrorMsgCode.UNABLE_ACQUIRE_DISTRIBUTED_LOCK, e);
    }
}
