...
/**
 * raw expression before parse to keywords
 * @author <mailto:eleven.hm@vip.163.com">eleven</a>
 * @see
 * @since 1.0.0
 */

public class RawExpressionKeywords extends Keywords {

    private KeywordsExpressionSource.ExpressionKey expressionKey;

    public RawExpressionKeywords(KeywordsExpressionSource.ExpressionKey expressionKey) {
