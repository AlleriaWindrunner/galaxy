...
public interface AuthenticationProcessor {
     ...
     * @return
     * @throws LemonAuthenticationException 认证失败抛出 LemonAuthenticationException 异常
     */
    UserInfoBase processAuthentication(Authentication authentication) throws LemonAuthenticationException;
}
