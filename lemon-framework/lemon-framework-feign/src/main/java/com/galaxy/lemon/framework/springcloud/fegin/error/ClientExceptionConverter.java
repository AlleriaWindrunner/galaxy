...
public class ClientExceptionConverter implements ExceptionConverter {
    ...
    public AlertCapable convert(Throwable throwable) {
        return ExceptionConverter.isTimeOutException(throwable.getCause()) ? ErrorMsgCode.CLIENT_TIMEOUT : ErrorMsgCode.CLIENT_EXCEPTION;
    }
}
